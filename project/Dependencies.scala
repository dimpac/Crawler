...
object Dependencies {
  ...
  lazy val etlToolbeltDep = Seq (
    "default" %% "etltoolbelt"  % "0.1"
  )

  lazy val coreDeps = kafkaDep ++ jsoupDep ++ typesafeDeps ++ logbackDep ++ sparkDeps ++ elasticSearchDep ++ etlToolbeltDep
